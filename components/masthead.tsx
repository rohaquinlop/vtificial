...
const Masthead : React.FC = () => {
  ...
  <div
    ...
    <div className={`flex-grow-0 pt-10 transition-opacity duration-1000 ${imageLoaded? 'opacity-100' : 'opacity-0'}`}>
      <Image src="/assets/logo.png" width={128/3} height={128/3} alt='logo'/>
    </div>
    <div className='p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex-1 flex items-center justify-center flex-col'>
      <h1 className='mb-6 text-4xl xl:text-5xl'>Vtificial</h1>
      <h2 className='mb-2 text-2xl xl:text-3xl tracking-tight'>
        <span>Modern companies require</span> <span>modern solutions</span>
      </h2>
    </div>
